...
`GREV_HOME_ROOT` can redirect the entire Grev Home data root for development/testing. Normal Grev Home operation uses `C:\GrevCo\GrevHome`, which is created automatically on first run.
