...
public static class DashboardTileCatalog
{
    ...
    [
        ...
        new("files", "Grev Files", "Browse local files and folders", "#51432A", "builtin://dashboard/files"),
        new("grev-dad", "Grev.dad", "Your account, friends and community", "#21464B", "builtin://dashboard/web"),
        new("web-browser", "Grev Web", "Search Google and browse the web", "#284D43", "builtin://dashboard/web"),
        ...
        new("my-profile", "My Profile", "Playtime, level and profile tiles", "#2B3A63", "builtin://dashboard/profile"),
        new("users-controllers", "Users & Controllers", "Sign in players and assign controllers", "#1F4750", "builtin://dashboard/players"),
        new("add-game", "Add a Game", "Add one game file to your library", "#3A4A28", "builtin://dashboard/add-game"),
        ...
        new("settings-game-scan", "Game Scanning", "Scan a folder and add games automatically", "#2A4740", "builtin://dashboard/scan"),
