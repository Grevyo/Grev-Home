...
public sealed class GameBoxArtService : IDisposable
{
    ...
    private static string? GetThumbnailSystem(GamePlatform platform) => platform switch
    {
        ...
        GamePlatform.WiiU => "Nintendo_-_Wii_U",
        ...
        GamePlatform.PlayStation3 => "Sony_-_PlayStation_3",
        GamePlatform.PlayStationPortable => "Sony_-_PlayStation_Portable",
        GamePlatform.PlayStationVita => "Sony_-_PlayStation_Vita",
        GamePlatform.Xbox => "Microsoft_-_Xbox",
        GamePlatform.Xbox360 => "Microsoft_-_Xbox_360",
