...
public partial class ThemeFilePickerView : UserControl
{
    private static readonly HashSet<string> SupportedExtensions = new(StringComparer.OrdinalIgnoreCase) { ".json" };
    ...
    public ThemeFilePickerView() => InitializeComponent();

    public void ShowHome(IReadOnlyList<FileHomeLocation> locations)
    {
        PathText.Text = "Theme file locations";
        ...
        StatusText.Text = "Exported themes land in Downloads by default. Browse anywhere else a .theme.json file was copied to.";
    }
    ...
    public void ShowDirectory(string path, IReadOnlyList<FileBrowserEntry> entries, bool canGoUp)
    {
        ...
        StatusText.Text = EntriesPanel.Children.Count == 0
            ? "No .json theme files are visible in this folder."
            : "Select a theme file to load it into the Theme Creator.";
    }
    ...
    private void Item_Click(object sender, RoutedEventArgs e)
    {
        ...
        else FileSelected?.Invoke(item.Path);
    }
